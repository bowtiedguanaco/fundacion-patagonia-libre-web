    ...
    <div style={styles.page}>
      ...
      <section style={styles.redesSection}>
        ...
        <div style={styles.redesIconsRow}>
          <a href="https://twitter.com/patagonialib" target="_blank" rel="noopener noreferrer" style={styles.redesIconLink} aria-label="Twitter / X">
          ...
          <a href="https://instagram.com/patagonialib" target="_blank" rel="noopener noreferrer" style={styles.redesIconLink} aria-label="Instagram">
            <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
